        ...
        for i in indices:
            ...
            if normpath != norminfile or not skipOriginalMorph:
                ...
                if n_vertices != n_morph_vertices:
                    ...
                    print ("WARNING: skipping morph ",name," with different number of vertices ",n_morph_vertices," than the original model ",n_vertices)
                    ...
                    print ("adding ",name," with ",n_morph_vertices," vertices")
    ...
    for mfilepattern in colorfiles.split():
        ...
        for path in matches:
            ...
            if n_vertices != n_morph_vertices:
                ...
                print ("WARNING: skipping morph color map ",name," with different number of vertices ",n_morph_vertices," than the original model ",n_vertices)

            elif n_faces != n_morph_faces:

                print ("WARNING: skipping morph color map ",name," with different number of faces ",n_morph_faces," than the original model ",n_faces)
                ...
                print ("adding ",name," with ",len(morphFaceColors)," face colors")
...
def convert_ascii(infile, morphfiles, colorfiles, outfile):
    ...
    print (len(vertices)," vertices, ",len(faces)," faces, ",len(materials)," materials")
...
# #############################################################################
def usage():
    print ("Usage: ",os.path.basename(sys.argv[0])," -i filename.obj -o filename.js [-m morphfiles*.obj] [-c morphcolors*.obj] [-a center|top|bottom] [-s flat|smooth] [-t binary|ascii] [-d invert|normal]")
...
if __name__ == "__main__":
    ...
    if morphfiles:
        print ("Morphs ",morphfiles)

    if colorfiles:
        print ("Colors ",colorfiles)
